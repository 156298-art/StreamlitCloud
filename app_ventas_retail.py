# -*- coding: utf-8 -*-
"""MGR_Ejercicio4_C4_JETP.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1k6i0LrMihNrie7IRVDbdV1Evj6u8be_K
"""

#Paso 0 - Creación Dataset
...
#Paso 2 - Configuración centralizad de parámetros
...
#Paso 4 - Función de procesamiento
...
#EJERCICIO 2 - SISTEMAS DE REPORTES AUTOMATICOS con visualizaciones usando Ploty
...
def generar_reporte_completo(modelo, metricas, y_real, y_pred, feature_names):
    ...
    <head>
        ...
        <style>
            ...
            .metrics {{ background-color: #f8f9fa; padding: 20px; border-radius: 5p
x; margin: 20px 0; }}
    ...
    html_content += """
        ...
        <ul>
            ...
            <li>Considerar reentrenamiento si el error aumenta significativamente</
li>
...
#EJERCICIO 3 : Configuración de Ejecución Programada con google app scropt
...
#Paso 4 y 5 configurar trigger automatico app script
